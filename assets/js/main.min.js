(() => {
  ...
  var updatePropertiesList = () => {
    var _a2;
    const filterItem = document.querySelector(".results-filters-items");
    let filterButtons = filterItem.querySelectorAll("button.result-filter"), formData = new FormData(), resultsBlock = document.getElementById("result-tabs-list-panel"), h2Block = document.querySelector(".title-top h2"), action = filterItem == null ? void 0 : filterItem.querySelector('input[name="action"]'), allInputs = filterItem == null ? void 0 : filterItem.querySelectorAll("input");
