(() => {
  ...
  document.addEventListener("click", (e) => {
    ...
    if (!imgTag) return;
    const src = trigger.getAttribute("data-plan-src") || trigger.getAttribute("src") || ((_a = trigger.querySelector("img")) == null ? void 0 : _a.getAttribute("src"));
  ...
  var initDefaultTabs = () => {
    ...
    containers.forEach((container) => {
      ...
      const initialKey = (_c = (_a = buttons.find((button) => button.classList.contains("active"))) == null ? void 0 : _a.dataset.tab) != null ? _c : (_b = buttons[0]) == null ? void 0 : _b.dataset.tab;
      panels.forEach((panel) => {
  ...
  var initSearchTabs = async () => {
    ...
    containers.forEach((container) => {
      ...
      const getOptionLabel = (filterKey, value) => {
        var _a2, _b2, _c;
        const filter = (_a2 = searchData == null ? void 0 : searchData.filters) == null ? void 0 : _a2[filterKey];
        const option = (_b2 = filter == null ? void 0 : filter.options) == null ? void 0 : _b2.find((opt) => (opt == null ? void 0 : opt.value) === value);
      ...
      const renderDropdown = (filterKey) => {
        ...
        const dropdown = container.querySelector(`[data-search-dropdown="${filterKey}"]`);
        const filter = (_a2 = searchData == null ? void 0 : searchData.filters) == null ? void 0 : _a2[filterKey];
        if (!dropdown || !((_b2 = filter == null ? void 0 : filter.options) == null ? void 0 : _b2.length)) return;
        ...
        const currentValue = (_e = (_d = (_c = filterBindings[filterKey]) == null ? void 0 : _c.value) == null ? void 0 : _d.value) != null ? _e : "";
        updateDropdownSelection(filterKey, currentValue);
      };
      const applyCategoryDefaults = (type) => {
        var _a2;
        const category = (_a2 = searchData == null ? void 0 : searchData.categories) == null ? void 0 : _a2.find((c) => (c == null ? void 0 : c.slug) === type);
      ...
      const initialType = (_b = (_a = activeTab == null ? void 0 : activeTab.dataset) == null ? void 0 : _a.type) != null ? _b : typeField.value;
      ...
      tabs.forEach((tab) => {
        tab.addEventListener("click", () => {
          ...
          const type = (_a2 = tab.dataset.type) != null ? _a2 : "";
  ...
  // dev/src/html/sections/index/map/map.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    loadMapIframe();
  });
  ...
  var initSearchResultsFilters = async () => {
    ...
    const ensureValueTextSpan = (valueEl) => {
      ...
      span.textContent = ((_a = valueEl.textContent) != null ? _a : "").trim();
    ...
    const getInitialValue = (filterKey, options, currentLabel) => {
      ...
      const byLabel = options.find((opt) => {
        var _a2;
        return ((_a2 = opt == null ? void 0 : opt.label) != null ? _a2 : "").trim().toLowerCase() === normalized;
      });
      if (byLabel == null ? void 0 : byLabel.value) return byLabel.value;
      return (_b = (_a = options[0]) == null ? void 0 : _a.value) != null ? _b : "";
    };
    const getLabelByValue = (filterKey, value) => {
      var _a, _b, _c;
      const options = (_a = filters == null ? void 0 : filters[filterKey]) == null ? void 0 : _a.options;
      if (!Array.isArray(options)) return value;
      return (_c = (_b = options.find((opt) => (opt == null ? void 0 : opt.value) === value)) == null ? void 0 : _b.label) != null ? _c : value;
    };
    ...
    const renderDropdown = (button) => {
      ...
      if (!dropdown) return;
      dropdown.replaceChildren();
      const selectedValue = (_b = button.dataset.selectedValue) != null ? _b : "";
      options.forEach((opt) => {
    ...
    buttons.forEach((button) => {
      ...
      if (!valueEl) return;
      const textSpan = ensureValueTextSpan(valueEl);
      const initialValue = getInitialValue(filterKey, options, (_b = textSpan.textContent) != null ? _b : "");
  ...
  var updatePropertiesList = () => {
    var _a;
    const filterItem = document.querySelector(".results-filters-items");
    let filterButtons = filterItem.querySelectorAll("button.result-filter"), formData = new FormData(), resultsBlock = document.getElementById("result-tabs-list-panel"), contentList = resultsBlock.querySelector(".content-list"), contentScroll = document.querySelector(".result-tabs-content-inner .content-scroll"), resultTabs = document.querySelector(".result-tabs"), h2Block = resultsBlock.querySelector(".title-top h2"), bedsValueInput = filterItem.querySelector('input[name="beds"]'), bathsValueInput = filterItem.querySelector('input[name="baths"]'), action = filterItem.querySelector('input[name="action"]');
    resultTabs.classList.add("preloader");
    formData.append("action", (_a = action.value) != null ? _a : "get_properties");
