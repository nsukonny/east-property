  ...
  var initSearchTabs = async () => {
    ...
    containers.forEach((container) => {
      ...
      const getOptionLabel = (filterKey, value) => {
        ...
        const option = (_b3 = filter == null ? void 0 : filter.options) == null ? void 0 : _b3.find((opt) => (opt == null ? void 0 : opt.value) === value);
        return (_c2 = option == null ? void 0 : option.label) != null ? _c2 : value;
      };
      ...
      const applyCategoryDefaults = (type) => {
        ...
        const defaults2 = category == null ? void 0 : category.defaults;
        if (!defaults2) return;
        if (typeof defaults2.developer === "string") setFilterValue("developer", defaults2.developer);
        if (typeof defaults2.location === "string") setFilterValue("location", defaults2.location);
      };
