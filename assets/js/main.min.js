...
<text x="50%" y="50%" style="fill:#fff" text-anchor="middle" font-size="50" dominant-baseline="middle" font-family="roboto,arial,sans-serif">${count}</text>
  ...
  var PropertyMap = class _PropertyMap {
    ...
    renderSingleMarker(AdvancedMarkerElement) {
      ...
      markerElement.innerHTML = '<img src="' + this.root.dataset.singleGeoMarker + '" width="22" height="28" alt="' + __2("Location", "east-property") + '">';
    ...
    setSelectionMarker(position, AdvancedMarkerElement) {
      ...
      if (!this.selectionMarker) {
        this.selectionMarker = new AdvancedMarkerElement({
          ...
          title: __2("Selected location", "east-property"),
          gmpDraggable: true
        });
      ...
      return {
        render: ({ count, position, markers }) => {
          ...
          return new AdvancedMarkerElement({
            position,
            content: element,
            title: `${count} ${__2("projects on the map", "east-property")}`,
  ...
  // src/js/filters.js
  var { __: __3, _n, _x, sprintf } = window.wp.i18n;
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
  ...
  var getBedsBathsText2 = (selectedBeds, selectedBaths) => {
    ...
    if (bedsArray.length > 0) {
      text += bedsArray.join(",") + " ";
      text += bedsArray.length > 1 || bedsArray.includes("7+") ? __3("beds", "east-property") : __3("bed", "east-property");
    }
    if (bathsArray.length > 0) {
      if (text) text += ", ";
      text += bathsArray.join(",") + " ";
      text += bathsArray.length > 1 || bathsArray.includes("5+") ? __3("baths", "east-property") : __3("bath", "east-property");
    }
    return text || __3("Select", "east-property");
  };
