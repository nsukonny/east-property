(() => {
  ...
  var SEARCH_DATA_URL = "/data/search.json";

  // dev/src/js/common/common.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
  });
  var loadSearchData = /* @__PURE__ */ (() => {
    let cache = null;
    return async () => {
  ...
  // dev/src/html/components/ui/search-tabs/search-tabs.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    void initSearchTabs();
  });
  ...
  // dev/src/html/components/ui/contact-panel/contact-panel.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    showContactPanel();
  });
  var showContactPanel = () => {
  ...
  // dev/src/html/components/filters/result-filters/filters.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
  ...
  // dev/src/html/sections/single/items/swiper.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    initSwiperThumbs();
  });
  ...
  // dev/src/html/sections/single/dropdowns/dropdowns.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    toggleDropdown();
  });
