  ...
  var initSearchTabs = async () => {
    ...
    containers.forEach((container) => {
      ...
      const applyCategoryDefaults = (type) => {
        ...
        if (!defaults2) return;
        if (typeof defaults2.available === "string") setFilterValue("available", defaults2.available);
        if (typeof defaults2.price === "string") setFilterValue("price", defaults2.price);
      };
