(() => {
  ...
  var initSearchTabs = async () => {
    ...
    containers.forEach((container) => {
      ...
      const initialType = (_b2 = (_a2 = activeTab == null ? void 0 : activeTab.dataset) == null ? void 0 : _a2.type) != null ? _b2 : typeField.value;
...
<text x="50%" y="50%" style="fill:#fff" text-anchor="middle" font-size="50" dominant-baseline="middle" font-family="roboto,arial,sans-serif">${count}</text>
      ...
      return {
        render: ({ count, position, markers }) => {
          ...
          return new AdvancedMarkerElement({
            position,
            content: element,
            title: `${count} ${__3("projects on the map", "east-property")}`,
  ...
  // src/js/filters.js
  var { __: __4, _n, _x, sprintf } = window.wp.i18n;
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
