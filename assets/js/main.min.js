(() => {
  ...
  // dev/src/js/common/global.js
  var WINDOW_WIDTH_LG = 992;

  // dev/src/js/common/common.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
  });
  ...
  // dev/src/js/common/beds-baths.js
  ...
  // dev/src/html/components/common/header/header-menu.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    initHeaderMenu();
  });
  ...
  var initSearchResultsFilters = async () => {
    ...
    const ensureValueTextSpan = (valueEl) => {
      ...
      span.textContent = ((_a3 = valueEl.textContent) != null ? _a3 : "").trim();
    ...
    const getInitialValue = (filterKey, options, currentLabel) => {
      ...
      const byLabel = options.find((opt) => {
        var _a4;
        return ((_a4 = opt == null ? void 0 : opt.label) != null ? _a4 : "").trim().toLowerCase() === normalized;
      });
      if (byLabel == null ? void 0 : byLabel.value) return byLabel.value;
      return (_b3 = (_a3 = options[0]) == null ? void 0 : _a3.value) != null ? _b3 : "";
    };
    const getLabelByValue = (filterKey, value) => {
      var _a3, _b3, _c2;
      const options = (_a3 = filters == null ? void 0 : filters[filterKey]) == null ? void 0 : _a3.options;
      if (!Array.isArray(options)) return value;
      return (_c2 = (_b3 = options.find((opt) => (opt == null ? void 0 : opt.value) === value)) == null ? void 0 : _b3.label) != null ? _c2 : value;
    };
    ...
    const renderDropdown = (button) => {
      ...
      if (!dropdown) return;
      dropdown.replaceChildren();
      const selectedValue = (_b3 = button.dataset.selectedValue) != null ? _b3 : "";
      options.forEach((opt) => {
    ...
    buttons.forEach((button) => {
      ...
      if (!valueEl) return;
      const textSpan = ensureValueTextSpan(valueEl);
      const initialValue = getInitialValue(filterKey, options, (_b3 = textSpan.textContent) != null ? _b3 : "");
    ...
    const closeDropdown = (button) => {
      if (!button) return;
      const filterKey = button.dataset.filter;
      const dropdown = button.querySelector(".result-dropdown") || button.parentElement.querySelector(`[data-result-dropdown="${filterKey}"]`);
      if (!dropdown) return;
      dropdown.hidden = true;
    ...
    if (bedsBathsSelector && bedsBathsDropdown && bedsBathsText && bedsValueInput && bathsValueInput) {
      ...
      if (0 < ((_a2 = searchData.filters.beds) == null ? void 0 : _a2.options.length)) {
      ...
      let selectedBaths = /* @__PURE__ */ new Set();
      if (0 < ((_b2 = searchData.filters.baths) == null ? void 0 : _b2.options.length)) {
