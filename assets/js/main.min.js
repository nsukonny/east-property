(() => {
  ...
  var require_filepond = __commonJS({
    "node_modules/filepond/dist/filepond.js"(exports, module) {
      (function(global, factory) {
        ...
        var createElement2 = function createElement3(tag, className) {
        ...
        var testElement = isBrowser() ? createElement2("svg") : {};
        ...
        var addGetSet = function addGetSet2(keys2, obj, props) {
        ...
        var styles = function styles2(_ref) {
          ...
          var getRect2 = function getRect3() {
          ...
          mixinConfig.forEach(function(key) {
            viewProps[key] = typeof initialProps[key] === "undefined" ? defaults3[key] : initialProps[key];
          });
          return {
            write: function write2() {
        ...
        var createView = (
          ...
          function createView2() {
            ...
            } : _ref$create, _ref$destroy = _ref.destroy, destroy2 = _ref$destroy === void 0 ? function() {
            ...
            return function(store) {
              ...
              var element = createElement2(tag, "filepond--" + name2, attributes);
        ...
        var toString2 = function toString3(value) {
          return "" + value;
        };
        var toArray2 = function toArray3(value) {
          ...
          return toString2(value).split(splitter).map(trim).filter(function(str) {
            return str.length;
          });
        };
        ...
        var toNumber = function toNumber2(value) {
          return isNumber(value) ? value : isString(value) ? toString2(value).replace(/[a-z]+/gi, "") : 0;
        };
        ...
        var toBytes = function toBytes2(value) {
          ...
          var naturalFileSize = toString2(value).trim();
        ...
        var isAPI = function isAPI2(value) {
          return isObject3(value) && isString(value.url) && isObject3(value.process) && isObject3(value.revert) && isObject3(value.restore) && isObject3(value.fetch);
        };
        ...
        var conversionTable = {
          ...
          string: function string(value) {
            return isFunction(value) ? value : toString2(value);
          },
        ...
        function _defaults(obj, defaults4) {
          var keys2 = Object.getOwnPropertyNames(defaults4);
          for (var i = 0; i < keys2.length; i++) {
            var key = keys2[i];
            var value = Object.getOwnPropertyDescriptor(defaults4, key);
        ...
        function _getDecoratorsApi() {
          ...
          var api = {
            ...
            toElementDescriptor: function(elementObject) {
              ...
              var key = _toPropertyKey2(elementObject.key);
        ...
        function _createElementDescriptor(def) {
          var key = _toPropertyKey2(def.key);
          var descriptor;
          if (def.kind === "method") {
            descriptor = {
              value: def.value,
        ...
        var extendDefaultOptions = function extendDefaultOptions2(additionalOptions) {
          return Object.assign(defaultOptions2, additionalOptions);
        };
        var getOptions = function getOptions2() {
          return Object.assign({}, defaultOptions2);
        };
        var setOptions2 = function setOptions3(opts) {
          forin(opts, function(key, value) {
            if (!defaultOptions2[key]) {
              return;
            }
            defaultOptions2[key][0] = getValueByType(
              value,
              defaultOptions2[key][0],
              defaultOptions2[key][1]
            );
          });
        };
        var defaultOptions2 = {
        ...
        var isAsync = function isAsync2(state2) {
          return isObject3(state2.options.server) && (isObject3(state2.options.server.process) || isFunction(state2.options.server.process));
        };
        ...
        var sendRequest = function sendRequest2(data3, url, options) {
          ...
          process2.onprogress = function(e) {
            if (aborted) {
              return;
            }
        ...
        var deepCloneObject = function deepCloneObject2(src) {
          ...
          for (var key in src) {
            ...
            var v = src[key];
            target[key] = v && isObject3(v) ? deepCloneObject2(v) : v;
          }
          return target;
        };
          ...
          var api = Object.assign(
            {
              ...
              extend: function extend5(name2, handler) {
        ...
        var getItemByQueryFromState = function getItemByQueryFromState2(state2, itemHandler) {
          return function() {
            ...
            } : _ref$failure, options = _objectWithoutProperties2(_ref, ["query", "success", "failure"]);
            var item2 = getItemByQuery(state2.items, query);
            if (!item2) {
              failure({
        ...
        var createElement$1 = function createElement3(tagName) {
        ...
        var create2 = function create3(_ref) {
          ...
          props.progress = 0;
          props.opacity = 0;
          var svg = createElement2("svg");
          root2.ref.path = createElement2("path", {
            "stroke-width": 2,
        ...
        var item = createView({
          create: create$7,
          write: write$4,
          destroy: function destroy2(_ref7) {
        ...
        var addItemView = function addItemView2(_ref2) {
          ...
          if (interactionMethod !== InteractionMethod.NONE) {
            ...
            var dist = now2 - root2.ref.lastItemSpanwDate;
        ...
        var dragItem = function dragItem2(_ref4) {
          ...
          var oldIndex2 = dragState.getItemIndex(item2);
          if (!view) return;
          var dragPosition = {
        ...
        var browser2 = createView({
          ...
          create: create$a,
          destroy: function destroy2(_ref10) {
            var root2 = _ref10.root;
        ...
        var dropLabel = createView({
          ...
          ignoreRect: true,
          create: create$b,
          destroy: function destroy2(_ref2) {
        ...
        var getLinksFromTransferMetaData = function getLinksFromTransferMetaData2(dataTransfer) {
          ...
          if (typeof data3 === "string" && data3.length) {
            var matches2 = data3.match(/src\s*=\s*"(.+?)"/);
            if (matches2) {
              return [matches2[1]];
            }
          }
        ...
        var drop3 = function drop4(root2, clients) {
          return function(e) {
            e.preventDefault();
            var dataTransfer = e.dataTransfer;
            requestDataTransferItems(dataTransfer).then(function(items) {
        ...
        var write$9 = function write2(_ref3) {
          ...
          if (aspectRatio) {
            ...
            if (history2.length > MAX_BOUNCES * 2) {
              var l = history2.length;
              var bottom = l - 10;
              var bounces = 0;
              for (var i = l; i >= bottom; i--) {
                if (history2[i] === history2[i - 2]) {
                  bounces++;
                }
        ...
        var createApp = function createApp2() {
          ...
          var defaultOptions3 = getOptions();
          ...
          var createEvent = function createEvent2(name2) {
            return function(data3) {
              ...
              if (data3.hasOwnProperty("error")) {
                event2.error = data3.error ? Object.assign({}, data3.error) : null;
              }
              if (data3.status) {
                event2.status = Object.assign({}, data3.status);
              }
              if (data3.file) {
          ...
          var setOptions3 = function setOptions4(options) {
        ...
        if (supported()) {
          ...
          exports2.destroy = function destroy2(hook) {
    ...
    "node_modules/filepond-plugin-image-preview/dist/filepond-plugin-image-preview.js"(exports, module) {
      (function(global, factory) {
        ...
        function _defaults(obj, defaults3) {
          var keys2 = Object.getOwnPropertyNames(defaults3);
          for (var i = 0; i < keys2.length; i++) {
            var key = keys2[i];
        ...
        var pointsToPathShape = function pointsToPathShape2(points) {
          return points.map(function(point, index2) {
            return "".concat(index2 === 0 ? "M" : "L", " ").concat(point.x, " ").concat(point.y);
          }).join(" ");
        };
        ...
        var getImageRectZoomFactor = function getImageRectZoomFactor2(imageRect, cropRect, rotation, center) {
    ...
    <rect x="0" width="500" height="200" fill="currentColor" mask="url(#mask-__UID__)"></rect>
        ...
        var ColorMatrixWorker = function ColorMatrixWorker2() {
          self.onmessage = function(e) {
            ...
            var matrix2 = e.data.message.colorMatrix;
            ...
            var m44 = matrix2[18];
            var m45 = matrix2[19];
            var index2 = 0, r = 0, g = 0, b = 0, a = 0;
            for (; index2 < l; index2 += 4) {
              r = data2[index2] / 255;
              g = data2[index2 + 1] / 255;
              b = data2[index2 + 2] / 255;
              a = data2[index2 + 3] / 255;
              data2[index2] = Math.max(
                0,
                Math.min((r * m11 + g * m12 + b * m13 + a * m14 + m15) * 255, 255)
              );
              data2[index2 + 1] = Math.max(
                0,
                Math.min((r * m21 + g * m22 + b * m23 + a * m24 + m25) * 255, 255)
              );
              data2[index2 + 2] = Math.max(
                0,
                Math.min((r * m31 + g * m32 + b * m33 + a * m34 + m35) * 255, 255)
              );
              data2[index2 + 3] = Math.max(
                0,
        ...
        var createImageWrapperView = function createImageWrapperView2(_) {
          ...
          var canCreateImageBitmap = function canCreateImageBitmap2(file) {
            var userAgent2 = window.navigator.userAgent;
            var isFirefox = userAgent2.match(/Firefox\/([0-9]+)\./);
          ...
          return _.utils.createView({
            ...
            styles: ["height"],
            apis: ["height"],
            destroy: function destroy2(_ref13) {
        ...
        var plugin = function plugin2(fpAPI) {
          ...
          addFilter("CREATE_VIEW", function(viewAPI) {
            var is2 = viewAPI.is, view = viewAPI.view, query = viewAPI.query;
  ...
  var ModalManager = class {
    constructor() {
      ...
      this.openModals = /* @__PURE__ */ new Set();
    ...
    handleDocumentClick(event2) {
      ...
      if (openTrigger) {
        ...
        if (modal) {
          ...
          this.cloneAttributes(modal, event2.target);
        }
  ...
  var WINDOW_WIDTH_LG = 992;

  // src/js/common/common.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
  });
  var reCalculateDropdownHeight = (dropdown) => {
    const dropdownOpen = dropdown.querySelector(".dropdown-content"), dropdownInner = dropdown.querySelector(".dropdown-inner");
  ...
  document.addEventListener("click", (e) => {
    ...
    const imgTag = modal == null ? void 0 : modal.querySelector("[data-modal-img]");
    if (!imgTag) return;
    const src = trigger.getAttribute("data-plan-src") || trigger.getAttribute("src") || ((_a2 = trigger.querySelector("img")) == null ? void 0 : _a2.getAttribute("src"));
    if (src) imgTag.src = src;
  });
  document.addEventListener("click", (e) => {
    const brokerModalBtn = e.target.closest('[data-modal-open="broker-modal"]');
    if (!brokerModalBtn) return;
    const modal = document.querySelector('.modal-wrapper[data-modal-id="broker-modal"]'), phoneLink = modal == null ? void 0 : modal.querySelector("#bm_phone"), whatsAppLink = modal == null ? void 0 : modal.querySelector("#bm_whatsapp"), brokerPhone = brokerModalBtn.getAttribute("data-broker-phone"), brokerWhatsApp = brokerModalBtn.getAttribute("data-broker-whatsapp");
  ...
  var initDefaultTabs = () => {
    ...
    containers.forEach((container) => {
      ...
      const buttonByKey = /* @__PURE__ */ new Map();
      const panelByKey = /* @__PURE__ */ new Map();
      ...
      buttons.forEach((button) => {
        button.addEventListener("click", (event2) => {
          ...
          if (!key) return;
          activate(key);
          let currentUrl = window.location.href, newUrl = currentUrl;
      ...
      const initialKey = (_c2 = (_a2 = buttons.find((button) => button.classList.contains("active"))) == null ? void 0 : _a2.dataset.tab) != null ? _c2 : (_b2 = buttons[0]) == null ? void 0 : _b2.dataset.tab;
      panels.forEach((panel) => {
  ...
  // src/js/common/beds-baths.js
  var { __ } = window.wp.i18n;
  var getBedsBathsText = (selectedBeds, selectedBaths) => {
  ...
  var updateBedsBathsButtons = (container, tempBeds, tempBaths) => {
  ...
  var syncTempBedsBaths = (selectedBeds, selectedBaths) => {
    return {
  ...
  // src/js/search-tabs.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    void initSearchTabs();
    void initSearchInDropdowns();
  });
  var containerClosers = /* @__PURE__ */ new Map();
  ...
  var DISTRESS_TAB = "distress";
  var initSearchTabs = async () => {
    ...
    containers.forEach((container) => {
      ...
      const getOptionLabel = (filterKey, value) => {
        var _a3, _b3, _c2;
        const filter = (_a3 = searchData == null ? void 0 : searchData.filters) == null ? void 0 : _a3[filterKey];
        const option3 = (_b3 = filter == null ? void 0 : filter.options) == null ? void 0 : _b3.find((opt) => (opt == null ? void 0 : opt.value) === value);
        return (_c2 = option3 == null ? void 0 : option3.label) != null ? _c2 : value;
      };
      ...
      const renderDropdown = (filterKey) => {
        ...
        const dropdown = container.querySelector(`[data-search-dropdown="${filterKey}"]`);
        const filter = (_a3 = searchData == null ? void 0 : searchData.filters) == null ? void 0 : _a3[filterKey];
        if (!dropdown || !((_b3 = filter == null ? void 0 : filter.options) == null ? void 0 : _b3.length)) return;
        ...
        const currentValue = (_e = (_d2 = (_c2 = filterBindings[filterKey]) == null ? void 0 : _c2.value) == null ? void 0 : _d2.value) != null ? _e : "";
      ...
      const applyCategoryDefaults = (type) => {
        var _a3;
        const category = (_a3 = searchData == null ? void 0 : searchData.categories) == null ? void 0 : _a3.find((c) => (c == null ? void 0 : c.slug) === type);
        const defaults3 = category == null ? void 0 : category.defaults;
        if (!defaults3) return;
        if (typeof defaults3.developer === "string") setFilterValue("developer", defaults3.developer);
        if (typeof defaults3.location === "string") setFilterValue("location", defaults3.location);
      };
      renderDropdown("developer");
      renderDropdown("location");
      const activeTab = tabs.find((t) => t.classList.contains("is-active"));
      const initialType = (_b2 = (_a2 = activeTab == null ? void 0 : activeTab.dataset) == null ? void 0 : _a2.type) != null ? _b2 : "";
      ...
      tabs.forEach((tab) => {
        tab.addEventListener("click", () => {
          ...
          const type = (_a3 = tab.dataset.type) != null ? _a3 : "";
          togglePanels(type);
      ...
      if (bedsBathsSelector && bedsBathsDropdown && bedsBathsText && bedsValueInput) {
        let selectedBeds = /* @__PURE__ */ new Set();
        let selectedBaths = /* @__PURE__ */ new Set(["2"]);
    ...
    searchInputs.forEach((searchInput) => {
      ...
      searchInput.addEventListener("input", () => {
        ...
        options.forEach((option3) => {
          const span = option3.querySelector("span");
  ...
  var initHeaderMenu = () => {
    ...
    const drawerElement = navElement == null ? void 0 : navElement.querySelector(".header-nav-drawer");
    const closeButton = navElement == null ? void 0 : navElement.querySelector(".header-nav-close");
  ...
  var MSG_API_KEY_USED = "The 'apiKey' parameter was used in setOptions(), but 'key' is the correct parameter name. Please update your configuration.";
...
If your Content Security Policy uses "require-trusted-types-for 'script'", allow this policy with "trusted-types ${policyName} google-maps-api-loader google-maps-api#html lit-html". The "google-maps-api-loader", "lit-html", and "google-maps-api#html" policies are required for full Maps JavaScript API execution. Falling back to a string script URL.`;
  ...
  function getPolicy() {
    ...
    const trustedTypes2 = globalThis.trustedTypes;
    if (!trustedTypes2) {
      policy = fallbackPolicy;
      return policy;
    }
    try {
      policy = trustedTypes2.createPolicy(TRUSTED_TYPES_POLICY_NAME, {
  ...
  function areTypedArraysEqual(a, b) {
    let index2 = a.length;
    if (b.length !== index2 || a.byteOffset !== b.byteOffset) {
      return false;
    }
    if (a instanceof Float64Array || a instanceof Float32Array || HAS_FLOAT_16_ARRAY && a instanceof Float16Array) {
      while (index2-- > 0) {
        if (a[index2] !== b[index2] && (a[index2] === a[index2] || b[index2] === b[index2])) {
          return false;
        }
      }
      return true;
  ...
  var KDBush = class _KDBush {
     ...
     */
    static from(data2) {
      if (!data2 || data2.byteLength === void 0 || data2.buffer) {
      ...
      return new _KDBush(numItems, nodeSize, ArrayType, void 0, data2);
    }
    /**
     ...
     */
    constructor(numItems, nodeSize = 64, ArrayType = Float64Array, ArrayBufferType = ArrayBuffer, data2) {
      ...
      if (data2) {
        ...
        const data3 = this.data = new ArrayBufferType(HEADER_SIZE + coordsByteSize + idsByteSize + padCoords);
        this.ids = new this.IndexArrayType(data3, HEADER_SIZE, numItems);
        this.coords = new ArrayType(data3, HEADER_SIZE + idsByteSize + padCoords, numItems * 2);
        this._pos = 0;
        this._finished = false;
        new Uint8Array(data3, 0, 2).set([219, (VERSION << 4) + arrayTypeIndex]);
        new Uint16Array(data3, 2, 1)[0] = nodeSize;
        new Uint32Array(data3, 4, 1)[0] = numItems;
      }
    }
    /**
  ...
  var Supercluster = class {
    ...
    load(points) {
      ...
      for (let i = 0; i < points.length; i++) {
        ...
        if (this.options.reduce) data2.push(0);
      }
      let tree = this.trees[maxZoom + 1] = this._createTree(data2);
    ...
    getClusters(bbox, zoom) {
      ...
      for (const id of ids) {
        ...
        clusters.push(data2[k + OFFSET_NUM] > 1 ? getClusterJSON(data2, k, this.clusterProps) : this.points[data2[k + OFFSET_ID]]);
      }
      return clusters;
    }
    getChildren(clusterId) {
      ...
      const data2 = tree.data;
      if (originId * this.stride >= data2.length) throw new Error(errorMsg);
      const r = this.options.radius / (this.options.extent * Math.pow(2, originZoom - 1));
      const x = data2[originId * this.stride];
      const y = data2[originId * this.stride + 1];
      const ids = tree.within(x, y, r);
      const children = [];
      for (const id of ids) {
        const k = id * this.stride;
        if (data2[k + OFFSET_PARENT] === clusterId) {
          children.push(data2[k + OFFSET_NUM] > 1 ? getClusterJSON(data2, k, this.clusterProps) : this.points[data2[k + OFFSET_ID]]);
        }
      }
    ...
    _createTree(data2) {
      const tree = new KDBush(data2.length / this.stride | 0, this.options.nodeSize, Float32Array);
      for (let i = 0; i < data2.length; i += this.stride) tree.add(data2[i], data2[i + 1]);
      tree.finish();
      tree.data = data2;
      return tree;
    }
    _addTileFeatures(ids, data2, x, y, z2, tile) {
      for (const i of ids) {
        const k = i * this.stride;
        const isCluster = data2[k + OFFSET_NUM] > 1;
        let tags, px, py;
        if (isCluster) {
          tags = getClusterProperties(data2, k, this.clusterProps);
          px = data2[k];
          py = data2[k + 1];
        } else {
          const p = this.points[data2[k + OFFSET_ID]];
          tags = p.properties;
          const [lng, lat] = p.geometry.coordinates;
          px = lngX(lng);
          py = latY(lat);
        ...
        if (isCluster || this.options.generateId) {
          id = data2[k + OFFSET_ID];
        } else {
          id = this.points[data2[k + OFFSET_ID]].id;
        }
    ...
    _cluster(tree, zoom) {
      ...
      for (let i = 0; i < data2.length; i += stride) {
        if (data2[i + OFFSET_ZOOM] <= zoom) continue;
        data2[i + OFFSET_ZOOM] = zoom;
        const x = data2[i];
        const y = data2[i + 1];
        const neighborIds = tree.within(data2[i], data2[i + 1], r);
        const numPointsOrigin = data2[i + OFFSET_NUM];
        let numPoints = numPointsOrigin;
        for (const neighborId of neighborIds) {
          const k = neighborId * stride;
          if (data2[k + OFFSET_ZOOM] > zoom) numPoints += data2[k + OFFSET_NUM];
        }
        if (numPoints > numPointsOrigin && numPoints >= minPoints) {
          ...
          for (const neighborId of neighborIds) {
            const k = neighborId * stride;
            if (data2[k + OFFSET_ZOOM] <= zoom) continue;
            data2[k + OFFSET_ZOOM] = zoom;
            const numPoints2 = data2[k + OFFSET_NUM];
            wx += data2[k] * numPoints2;
            wy += data2[k + 1] * numPoints2;
            data2[k + OFFSET_PARENT] = id;
            if (reduce) {
              if (!clusterProperties) {
                clusterProperties = this._map(data2, i, true);
                clusterPropIndex = this.clusterProps.length;
                this.clusterProps.push(clusterProperties);
              }
              reduce(clusterProperties, this._map(data2, k));
            }
          }
          data2[i + OFFSET_PARENT] = id;
          nextData.push(wx / numPoints, wy / numPoints, Infinity, id, -1, numPoints);
          if (reduce) nextData.push(clusterPropIndex);
        } else {
          for (let j = 0; j < stride; j++) nextData.push(data2[i + j]);
          if (numPoints > 1) {
            for (const neighborId of neighborIds) {
              const k = neighborId * stride;
              if (data2[k + OFFSET_ZOOM] <= zoom) continue;
              data2[k + OFFSET_ZOOM] = zoom;
              for (let j = 0; j < stride; j++) nextData.push(data2[k + j]);
            }
          }
        }
      }
    ...
    _map(data2, i, clone2) {
      if (data2[i + OFFSET_NUM] > 1) {
        const props = this.clusterProps[data2[i + OFFSET_PROP]];
        return clone2 ? Object.assign({}, props) : props;
      }
      const original = this.points[data2[i + OFFSET_ID]].properties;
      const result = this.options.map(original);
      return clone2 && result === original ? Object.assign({}, result) : result;
    }
  };
  function getClusterJSON(data2, i, clusterProps) {
    return {
      type: "Feature",
      id: data2[i + OFFSET_ID],
      properties: getClusterProperties(data2, i, clusterProps),
      geometry: {
        type: "Point",
        coordinates: [xLng(data2[i]), yLat(data2[i + 1])]
      }
    };
  }
  function getClusterProperties(data2, i, clusterProps) {
    const count = data2[i + OFFSET_NUM];
    const abbrev = count >= 1e4 ? `${Math.round(count / 1e3)}k` : count >= 1e3 ? `${Math.round(count / 100) / 10}k` : count;
    const propIndex = data2[i + OFFSET_PROP];
    const properties = propIndex === -1 ? {} : Object.assign({}, clusterProps[propIndex]);
    return Object.assign(properties, {
      cluster: true,
      cluster_id: data2[i + OFFSET_ID],
      point_count: count,
  ...
  var AbstractViewportAlgorithm = class extends AbstractAlgorithm {
    constructor(_a2) {
      var { viewportPadding = 60 } = _a2, options = __rest(_a2, ["viewportPadding"]);
      super(options);
  ...
  var SuperClusterAlgorithm = class extends AbstractAlgorithm {
    constructor(_a2) {
      var { maxZoom, radius = 60 } = _a2, options = __rest(_a2, ["maxZoom", "radius"]);
      super({ maxZoom });
      this.markers = [];
      this.clusters = [];
      this.state = { zoom: -1 };
  ...
  var SuperClusterViewportAlgorithm = class extends AbstractViewportAlgorithm {
    constructor(_a2) {
      var { maxZoom, radius = 60, viewportPadding = 60 } = _a2, options = __rest(_a2, ["maxZoom", "radius", "viewportPadding"]);
...
<text x="50%" y="50%" style="fill:#fff" text-anchor="middle" font-size="50" dominant-baseline="middle" font-family="roboto,arial,sans-serif">${count}</text>
  ...
  function slideToLoop(index2 = 0, speed, runCallbacks = true, internal) {
    ...
    if (swiper.params.loop) {
      if (swiper.virtual && swiper.params.virtual.enabled) {
        ...
        if (gridEnabled) {
          const slideIndex = newIndex2 * swiper.params.grid.rows;
          newIndex2 = swiper.slides.find((slideEl) => slideEl.getAttribute("data-swiper-slide-index") * 1 === slideIndex).column;
        } else {
  ...
  function onTouchStart(event2) {
    ...
    const shouldPreventDefault = preventDefault3 && swiper.allowTouchMove && params.touchStartPreventDefault;
  ...
  function Navigation({
    ...
    function update2() {
      ...
      if (swiper.params.loop) {
        ...
        toggleEl(nextEl2, false);
        return;
      }
      toggleEl(prevEl, swiper.isBeginning && !swiper.params.rewind);
      toggleEl(nextEl2, swiper.isEnd && !swiper.params.rewind);
    }
    ...
    function init() {
      ...
      let nextEl2 = getEl(params.nextEl);
      let prevEl = getEl(params.prevEl);
      Object.assign(swiper.navigation, {
        nextEl: nextEl2,
        prevEl
      });
      nextEl2 = makeElementsArray(nextEl2);
      ...
      nextEl2.forEach((el) => initButton(el, "next"));
    ...
    function destroy2() {
      ...
      nextEl2.forEach((el) => destroyButton(el, "next"));
    ...
    on2("enable disable", () => {
      ...
      [...nextEl2, ...prevEl].filter((el) => !!el).forEach((el) => el.classList.add(swiper.params.navigation.lockClass));
    });
    on2("click", (_s, e) => {
      let {
        nextEl: nextEl2,
      ...
      let targetIsButton = prevEl.includes(targetEl) || nextEl2.includes(targetEl);
      if (swiper.isElement && !targetIsButton) {
        const path = e.path || e.composedPath && e.composedPath();
        if (path) {
          targetIsButton = path.find((pathEl) => nextEl2.includes(pathEl) || prevEl.includes(pathEl));
        }
      }
      if (swiper.params.navigation.hideOnClick && !targetIsButton) {
        ...
        let isHidden;
        if (nextEl2.length) {
          isHidden = nextEl2[0].classList.contains(swiper.params.navigation.hiddenClass);
        ...
        [...nextEl2, ...prevEl].filter((el) => !!el).forEach((el) => el.classList.toggle(swiper.params.navigation.hiddenClass));
      }
    });
    const enable = () => {
  ...
  function Thumb({
    ...
    function update2(initial, p) {
      ...
      if ((_a2 = p == null ? void 0 : p.autoScroll) != null ? _a2 : true) {
        autoScroll2(initial ? 0 : void 0);
      }
    }
    function autoScroll2(slideSpeed) {
      const thumbsSwiper = swiper.thumbs.swiper;
      if (!thumbsSwiper || thumbsSwiper.destroyed) return;
  ...
  // src/js/map/config.js
  var _a, _b, _c, _d;
  var MAP_CONFIG = {
    API_KEY: (_b = (_a = window.MAP_CONFIG) == null ? void 0 : _a.apiKey) != null ? _b : "",
    // How early a map starts before it scrolls into view.
    LAZY_ROOT_MARGIN: "300px",
    MAP_ID: (_d = (_c = window.MAP_CONFIG) == null ? void 0 : _c.mapId) != null ? _d : "",
  ...
  // src/js/map/map.js
  var { __: __3, sprintf } = window.wp.i18n;
  var startMap = (instance) => {
  ...
  var deferMaps = () => {
    ...
    const observer = supported ? new IntersectionObserver((entries, watcher) => {
      entries.forEach((entry) => {
        if (!entry.isIntersecting) return;
        watcher.unobserve(entry.target);
        startMap(entry.target);
      });
    }, { rootMargin: MAP_CONFIG.LAZY_ROOT_MARGIN }) : null;
    instances.forEach((instance) => {
      const modal = instance.closest(".modal-wrapper");
      if (modal) {
        const modalId = modal.getAttribute("data-modal-id");
        const onOpen = (event2) => {
          if (!event2.target.closest('[data-modal-open="' + modalId + '"]')) return;
  ...
  document.addEventListener("click", (event2) => {
    const button = event2.target.closest("[data-tab-button]");
    if (!button) return;
    let sectionAbout = document.querySelector("section.about"), footer = document.querySelector("footer");
    if ("map" === button.dataset.tab) {
      sectionAbout == null ? void 0 : sectionAbout.classList.add("is-hidden");
      footer == null ? void 0 : footer.classList.add("is-hidden");
    } else {
      sectionAbout == null ? void 0 : sectionAbout.classList.remove("is-hidden");
      footer == null ? void 0 : footer.classList.remove("is-hidden");
    }
  });
  var PropertyMap = class _PropertyMap {
    constructor(root) {
      var _a2, _b2;
      this.root = root;
      ...
      this.latitudeInputs = _PropertyMap.findCoordinateInputs("latitude");
      this.longitudeInputs = _PropertyMap.findCoordinateInputs("longitude");
      ...
      if (this.mode === "select" && ((_a2 = this.latitudeInput) == null ? void 0 : _a2.value) && ((_b2 = this.longitudeInput) == null ? void 0 : _b2.value)) {
    ...
    async init() {
      ...
      try {
        ...
        const properties = (_a2 = this.root.pendingProperties) != null ? _a2 : filterPropertiesJson;
        if (properties) {
        ...
        this.map = new Map2(this.container, {
    ...
    async loadProperties(props = null) {
      ...
      try {
        ...
        this.properties = Array.isArray(data2) ? data2 : [data2];
      } catch (error) {
    ...
    clearMarkers() {
      var _a2;
      (_a2 = this.clusterer) == null ? void 0 : _a2.clearMarkers();
    ...
    renderSingleMarker(AdvancedMarkerElement) {
      ...
      markerElement.innerHTML = '<img src="' + this.root.dataset.singleGeoMarker + '" width="22" height="28" alt="' + __3("Location", "east-property") + '">';
    ...
    initPointSelection(AdvancedMarkerElement, PlaceAutocompleteElement) {
      var _a2, _b2;
      const latitude = parseFloat((_a2 = this.latitudeInput) == null ? void 0 : _a2.value);
      const longitude = parseFloat((_b2 = this.longitudeInput) == null ? void 0 : _b2.value);
      if (!Number.isNaN(latitude) && !Number.isNaN(longitude)) {
        const position = {
          lat: latitude,
          lng: longitude
      ...
      this.map.addListener("click", (event2) => {
        if (!event2.latLng) {
          return;
        }
        this.setSelectionMarker(
    ...
    initAddressSearch(PlaceAutocompleteElement, AdvancedMarkerElement) {
      ...
      autocomplete.addEventListener(
        "gmp-placeselect",
        async (event2) => {
          const place = event2.placePrediction.toPlace();
          ...
          if (this.addressInput) {
            this.addressInput.value = place.formattedAddress || place.displayName || "";
          }
        }
      );
    }
    setSelectionMarker(position, AdvancedMarkerElement) {
      ...
      if (!this.selectionMarker) {
        this.selectionMarker = new AdvancedMarkerElement({
          ...
          title: __3("Selected location", "east-property"),
          gmpDraggable: true
        });
        this.selectionMarker.addListener(
          "dragend",
          () => {
            const markerPosition = this.selectionMarker.position;
            if (!markerPosition) {
              return;
            }
        ...
        this.selectionMarker.position = normalizedPosition;
    ...
    updateCoordinateInputs(position) {
      _PropertyMap.writeCoordinate(this.latitudeInputs, position.lat);
      _PropertyMap.writeCoordinate(this.longitudeInputs, position.lng);
    }
    /**
    ...
    updateSelectionMarkerFromInputs(AdvancedMarkerElement) {
      ...
      return {
        render: ({ count, position, markers }) => {
          const units = markers.reduce((sum, marker) => {
            var _a2;
            const available = parseInt((_a2 = marker.propertyData) == null ? void 0 : _a2.units_available, 10);
          ...
          return new AdvancedMarkerElement({
            ...
            title: sprintf(__3("%1$d projects \xB7 %2$d units", "east-property"), count, units),
    ...
    openSidebar(prop) {
      ...
      let formData = new FormData(), projectLink = this.sidebar.querySelector(".a-link .button");
  ...
  var initSingleSwiper = (container = document) => {
  ...
  var initGallerySlider = () => {
    document.addEventListener("click", (e) => {
      ...
      const gallery = trigger && ((_a2 = document.querySelector('[data-modal-id="gallery-modal"] .gallery-swiper')) == null ? void 0 : _a2.swiper);
      if (gallery) {
    ...
    document.addEventListener("keydown", (e) => {
      var _a2;
      const gallery = (_a2 = document.querySelector('.modal-wrapper-active[data-modal-id="gallery-modal"] .gallery-swiper')) == null ? void 0 : _a2.swiper;
  ...
  // src/js/filters.js
  var { __: __4, _n, _x, sprintf: sprintf2 } = window.wp.i18n;
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    void initSearchResultsFilters();
    initPropertiesFilters();
  });
  var getBedsBathsText2 = (selectedBeds, selectedBaths) => {
    const bedsArray = Array.from(selectedBeds).sort();
    const bathsArray = Array.from(selectedBaths).sort();
    let text = "";
    if (bedsArray.length > 0) {
      text += bedsArray.join(",") + " ";
      text += bedsArray.length > 1 || bedsArray.includes("7+") ? __4("beds", "east-property") : __4("bed", "east-property");
    }
    if (bathsArray.length > 0) {
      if (text) text += ", ";
      text += bathsArray.join(",") + " ";
      text += bathsArray.length > 1 || bathsArray.includes("5+") ? __4("baths", "east-property") : __4("bath", "east-property");
    }
    return text || __4("Select", "east-property");
  };
  var updateBedsBathsButtons2 = (container, tempBeds, tempBaths) => {
  ...
  var initSearchResultsFilters = async () => {
    const buttons = Array.from(document.querySelectorAll(".result-filter[data-filter]"));
    if (!buttons.length) return;
    let searchData = searchTabsData;
    const filters = searchData == null ? void 0 : searchData.filters;
    if (!filters) return;
    const getLabelByValue = (filterKey, value) => {
      var _a2, _b2, _c2;
      const options = (_a2 = filters == null ? void 0 : filters[filterKey]) == null ? void 0 : _a2.options;
      if (!Array.isArray(options)) return value;
      return (_c2 = (_b2 = options.find((opt) => (opt == null ? void 0 : opt.value) === value)) == null ? void 0 : _b2.label) != null ? _c2 : value;
    };
    ...
    const renderDropdown = (button) => {
      ...
      dropdown.replaceChildren();
      const selectedValue = (_b2 = button.dataset.selectedValue) != null ? _b2 : "";
      options.forEach((opt) => {
    ...
    buttons.forEach((button) => {
      ...
      const valueEl = button.querySelector(".result-value");
      if (!valueEl) return;
      const currentLabel = ((_d2 = (_c2 = (_b2 = valueEl.querySelector("[data-value-text]")) == null ? void 0 : _b2.textContent) != null ? _c2 : valueEl.textContent) != null ? _d2 : "").trim().toLowerCase();
      const initial = options.find((opt) => {
        var _a3;
        return ((_a3 = opt == null ? void 0 : opt.label) != null ? _a3 : "").trim().toLowerCase() === currentLabel;
      });
      const initialValue = !button.dataset.selectedValue && (initial == null ? void 0 : initial.value) ? (_e = options[0]) == null ? void 0 : _e.value : button.dataset.selectedValue;
    ...
    buttons.forEach((button) => {
      button.addEventListener("click", (e) => {
        ...
        const option3 = e.target.closest(".result-option");
        const filterKey = button.dataset.filter;
        if (!option3) {
          button.classList.contains("is-open") ? (closeDropdown(button), openButton = null) : openDropdown(button);
          return;
        }
        const selectedValue = option3.getAttribute("data-value");
    ...
    if (bbSelector && bbDropdown && bbText && bbBedsInp && bbBathsInp) {
      let selectedBeds = /* @__PURE__ */ new Set(), selectedBaths = /* @__PURE__ */ new Set();
      let tempBeds = /* @__PURE__ */ new Set(), tempBaths = /* @__PURE__ */ new Set();
      if (filters.beds) {
      ...
      const updateDisplay = () => {
        bbText.textContent = getBedsBathsText2(selectedBeds, selectedBaths);
      ...
      bbDropdown.addEventListener("click", (e) => {
        ...
        if (bedBtn) {
          ...
          updateBedsBathsButtons2(bbDropdown, tempBeds, tempBaths);
        }
        if (bathBtn) {
  ...
  var updatePropertiesList = () => {
    var _a2;
    const filterItem = document.querySelector(".results-filters-items");
    let filterButtons = filterItem.querySelectorAll("button.result-filter"), formData = new FormData(), resultsBlock = document.getElementById("result-tabs-list-panel"), contentList = resultsBlock.querySelector(".content-list"), resultTabs = document.querySelector(".result-tabs"), h2Block = resultsBlock.querySelector(".title-top h2"), h2BlockSpan = h2Block.querySelector("span"), action = filterItem.querySelector('input[name="action"]'), mapInstances = document.querySelectorAll(".js-map-instance"), allInputs = filterItem == null ? void 0 : filterItem.querySelectorAll("input");
    if (h2BlockSpan) {
      h2Block = h2BlockSpan;
    }
    resultTabs.classList.add("preloader");
    formData.append("action", (_a2 = action.value) != null ? _a2 : "get_properties");
    formData.append("_ajax_nonce", ajax_object._ajax_nonce);
    filterButtons.forEach((button) => {
    ...
    fetch(ajax_object.ajax_url, {
      ...
      if (response.success) {
        contentList.querySelectorAll(".swiper-initialized").forEach((el) => {
          var _a3;
          return (_a3 = el.swiper) == null ? void 0 : _a3.destroy(true, false);
        });
  ...
  var getUrlWithFilters = (formData) => {
  ...
  function removePaginationFromUrl(urlString = window.location.href) {
    ...
    url.pathname = url.pathname.replace(/\/page-\d+\/?$/i, "/").replace(/\/page\/\d+\/?$/i, "/").replace(/\/{2,}/g, "/");
    url.searchParams.delete("page");
    url.searchParams.delete("paged");
    url.searchParams.delete("pagination");
    return url.origin + url.pathname;
  }
  var initSearchInFilters = () => {
    ...
    searchInputs.forEach((searchInput) => {
      ...
      searchInput.addEventListener("input", () => {
        ...
        options.forEach((option3) => {
          ...
          const optionText = option3.textContent.toLowerCase();
          if (0 === searchValue.length) {
            option3.classList.remove("hidden");
            return;
          }
          if (optionText.includes(searchValue)) {
            option3.classList.remove("hidden");
            const regex = new RegExp(`(${searchValue})`, "gi");
            option3.innerHTML = option3.textContent.replace(regex, "<b>$1</b>");
          } else {
            option3.innerHTML = option3.textContent.replace(/<b>|<\/b>/g, "");
            option3.classList.add("hidden");
          }
        });
      });
  ...
  var toggleDropdown = () => {
    ...
    document.addEventListener("click", (e) => {
      var _a2;
      const option3 = e.target.closest(".dropdown-option");
      if (!option3) return;
      const dropdown = option3.closest(".dropdown");
      const button = dropdown.querySelector(".dropdown-button");
      const title = button.querySelector(".dropdown-title");
      const dropdownOpen = dropdown.querySelector(".dropdown-content");
      const hiddenInput = (_a2 = dropdown.closest(".input-wrapper")) == null ? void 0 : _a2.querySelector('input[type="hidden"]');
      if (title) title.textContent = option3.textContent;
      if (hiddenInput) {
        hiddenInput.value = option3.getAttribute("data-value") || option3.textContent;
        hiddenInput.dispatchEvent(new Event("input", { bubbles: true }));
        hiddenInput.dispatchEvent(new Event("change", { bubbles: true }));
      }
      dropdown.classList.remove("opened");
      if (dropdownOpen) dropdownOpen.style.height = "0";
      dropdown.dispatchEvent(new CustomEvent("change", { detail: { value: option3.textContent } }));
    });
  };
  var initSearch = (button) => {
    const dropdown = button.closest(".dropdown");
  ...
  // src/js/submit-unit.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    initFormInteractions();
    initFormValidation();
  });
  var initFormInteractions = () => {
    ...
    const numberFrom = (root, key) => {
      var _a2;
      return parseFloat((_a2 = root.querySelector(`input[data-lang-sync="${key}"]`)) == null ? void 0 : _a2.value) || 0;
    };
    ...
    const checkValidity = () => {
      ...
      const isFormValid = Array.from(requiredElements).every(
  ...
  var DESCRIPTION_MIN_LENGTH = 40;
  var descriptionEditorIds = (form) => Array.from(form.querySelectorAll('textarea[id^="s-desc"]')).map((el) => el.id);
  var isDescriptionTooShort = (editorId) => {
    var _a2;
    const editor = (_a2 = window.tinymce) == null ? void 0 : _a2.get(editorId);
    if (!editor) return false;
    return editor.getContent().length < DESCRIPTION_MIN_LENGTH;
  };
  var isLangFilled = (fieldset) => {
    var _a2, _b2;
    return "" !== ((_b2 = (_a2 = fieldset.querySelector('input[name$="[unit_title]"], input[name$="[title]"]')) == null ? void 0 : _a2.value.trim()) != null ? _b2 : "");
  };
  var syncLangRequirements = (form) => {
    ...
    fieldsets.forEach((fieldset) => {
      ...
      fieldset.querySelectorAll("[data-lang-required]").forEach((el) => {
        ...
        if (!isRequired) {
          (_a2 = el.closest(".submit-buttons-wrapper, .checkbox-buttons-wrapper, .input-wrapper")) == null ? void 0 : _a2.classList.remove("error-field");
        }
      });
    });
  };
  var isEditorLangFilled = (form, editorId) => {
  ...
  var initLangValidation = () => {
    ...
    const isLangIncomplete = (slug) => {
      ...
      const incomplete = Array.from(fieldset.querySelectorAll("[required], [data-required]")).some((el) => "checkbox" === el.type ? !el.checked : "" === String(el.value).trim());
  ...
  var initFormValidation = () => {
    ...
    const markSubmitAttempted = () => {
      ...
      syncLangRequirements(form);
      refreshLangErrors == null ? void 0 : refreshLangErrors();
    };
    ...
    ["input", "change"].forEach((eventName) => {
      form.addEventListener(eventName, () => {
        syncLangRequirements(form);
        if (submitAttempted) refreshLangErrors == null ? void 0 : refreshLangErrors();
      });
    });
    form.addEventListener("submit", (e) => {
      ...
      const listingType = ((_a2 = form.querySelector('input[name$="[listing_type]"]')) == null ? void 0 : _a2.value) || "";
      if ("distress" === listingType) {
        const price = parseFloat((_b2 = form.querySelector('input[data-lang-sync="price"]')) == null ? void 0 : _b2.value) || 0;
        const originalPriceInputs = form.querySelectorAll('input[data-lang-sync="original_price"]');
        const originalPrice = parseFloat((_c2 = originalPriceInputs[0]) == null ? void 0 : _c2.value) || 0;
        const isValid = price > 0 && originalPrice > price;
        originalPriceInputs.forEach((inp) => {
          var _a3;
          (_a3 = inp.closest(".input-group")) == null ? void 0 : _a3.classList.toggle("error-field", !isValid);
        });
        if (!isValid) {
          errors++;
        }
      ...
      descriptionEditorIds(form).forEach((editorId) => {
        var _a3;
        const wrapper = (_a3 = document.getElementById(`wp-${editorId}-wrap`)) == null ? void 0 : _a3.querySelector(".wp-editor-container");
        if (!wrapper) return;
      ...
      const finalImageSelectionInp = form.querySelector('input[name="final_image_selection"]'), imagesUploaderBlock = form.querySelector(".submit-unit-right .uploader");
  ...
  var PluginManager = {
    mount: function mount(plugin) {
      for (var option3 in defaults2) {
        if (defaults2.hasOwnProperty(option3) && !(option3 in plugin)) {
          plugin[option3] = defaults2[option3];
        }
      }
    ...
    initializePlugins: function initializePlugins(sortable, el, defaults3, options) {
      ...
      for (var option3 in sortable.options) {
        if (!sortable.options.hasOwnProperty(option3)) continue;
  ...
  var initUploader = () => {
    ...
    const syncPresetsFromDom = () => {
      presets = Array.from(getPresetsGrid().querySelectorAll(".uploader-item")).map((el) => {
    ...
    const syncToHidden = () => {
      ...
      const payload = {
        user: userFiles.map((f) => {
          var _a2;
          return (_a2 = f.attachmentId) != null ? _a2 : f.id;
        }),
    ...
    const createItemEl = (file) => {
      ...
      if (file.canDelete) {
        ...
        delBtn.addEventListener("click", (e) => {
          ...
          if (file.isOldImage) {
            let item = document.querySelector('.uploader-item[data-id="' + file.id + '"]'), userThumbnailIds = document.getElementById("user-thumbnail-ids");
        ...
        server: {
          process: {
            ...
            onload: (response) => {
              ...
              if (data2.success && data2.data && data2.data.attachment_id) {
                userThumbnailIds.value += data2.data.attachment_id + ",";
                userFiles.find((f) => f.attachmentId === null).attachmentId = data2.data.attachment_id;
                return String(data2.data.attachment_id);
              }
            ...
            onerror: (response) => {
              ...
              try {
                const data2 = JSON.parse(response);
                return ((_a2 = data2 == null ? void 0 : data2.data) == null ? void 0 : _a2.message) || "Upload error";
              } catch (e) {
                return "Upload error";
              }
            }
    ...
    [uGrid, pGrid].forEach((grid) => {
      sortable_esm_default.create(grid, {
        animation: 150,
        ghostClass: "sortable-ghost",
        onEnd: () => {
      ...
      try {
        ...
        if (result.success && result.data.html) {
          ...
          if (result.data.has_more && result.data.next_page <= totalPages) {
            ...
            (_a2 = loadMoreBtn.closest(".news-archive-more")) == null ? void 0 : _a2.remove();
          }
        } else {
          (_b2 = loadMoreBtn.closest(".news-archive-more")) == null ? void 0 : _b2.remove();
        }
      } catch (error) {
  ...
  // src/js/mortgage-calculator/config/defaults.js
  ...
  // src/js/mortgage-calculator/config/residency.js
  var RESIDENCY = Object.freeze({
  ...
  // src/js/mortgage-calculator/config/ranges.js
  ...
  // src/js/mortgage-calculator/config/chart.js
  var CHART_CONFIG = Object.freeze({
    size: 71,
    rOuter: 33.5,
    rInner: 27.5,
    whiteBorder: 4,
  ...
  var SLIDER_CONFIG = Object.freeze({
    filledTrackColor: CALC_COLORS.orange,
    unfilledTrackColor: CALC_COLORS.wheat
  });

  // src/js/mortgage-calculator/config/formatting.js
  var FORMATTING = Object.freeze({
    locale: "ru-RU",
    currencyUnit: "AED"
  });

  // src/js/mortgage-calculator/modules/math.js
  function calculateMortgage({ price, downPct, years, rate }) {
  ...
  function calculateEntryCosts(price, downPct) {
    const safePrice = Math.max(0, Number(price) || 0);
    const safeDownPct = Math.min(100, Math.max(0, Number(downPct) || 0));
    const downAmount = Math.round(safePrice * (safeDownPct / 100));
    const loanAmount = Math.max(0, safePrice - downAmount);
    ...
    const mortgageRegFee = Math.round(loanAmount * 25e-4 + 290);
  ...
  // src/js/mortgage-calculator/modules/formatter.js
  var numberFormatter = new Intl.NumberFormat(FORMATTING.locale, {
  ...
  function parseNumericInput(rawValue) {
    ...
    const sanitized = String(rawValue).replace(/\s+/g, "").replace(/,/g, ".").replace(/[^0-9.]/g, "");
  ...
  // src/js/mortgage-calculator/modules/donut-chart.js
  var DonutChart = class {
    constructor(canvas) {
      this.canvas = canvas;
      this.ctx = (canvas == null ? void 0 : canvas.getContext("2d")) || null;
  ...
  // src/js/mortgage-calculator/modules/pdf/logo.js
  var LOGO_SVG = `<svg width="120" height="45" viewBox="0 0 132 50" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M0 50V7.14282L13.7481 24.4462C16.1501 27.4692 17.4565 31.2085 17.4565 35.0602V50H0Z" fill="#FFA41B"/>
<path d="M23.8042 27.9174V42.8571H18.6466C18.6466 42.8571 18.6861 40.2823 18.6466 37.3016C18.6151 34.9276 18.5596 32.379 18.1648 30.9524C17.2863 27.7778 15.8694 25 13.0922 21.8254C9.52157 17.3033 6.34766 13.2653 6.34766 13.2653V0L20.0958 17.3033C22.4977 20.3264 23.8042 24.0657 23.8042 27.9174Z" fill="#16181D"/>
<path d="M132.001 28.801L127.412 38.3543H123.316L118.728 28.801H123.119L124.832 33.0754C124.951 33.3643 125.036 33.6795 125.088 34.0209C125.141 34.3623 125.193 34.684 125.246 34.9861H125.502C125.555 34.684 125.607 34.3623 125.66 34.0209C125.725 33.6663 125.811 33.3446 125.916 33.0557L127.609 28.801H132.001ZM127.511 35.9315V42.3923H123.237V35.9315H127.511Z" fill="#16181D"/>
<path d="M114.926 28.801V42.3923H110.652V28.801H114.926ZM118.727 28.801V31.992H106.852V28.801H118.727Z" fill="#16181D"/>
<path d="M100.237 28.6042C101.576 28.6042 102.666 28.729 103.506 28.9785C104.346 29.228 104.963 29.6548 105.357 30.2588C105.764 30.8498 105.968 31.6771 105.968 32.7407C105.968 33.2791 105.882 33.7847 105.712 34.2574C105.554 34.7171 105.272 35.0979 104.865 35.3999C104.471 35.7019 103.92 35.8923 103.211 35.9711V36.0893C103.46 36.1156 103.736 36.1944 104.038 36.3257C104.34 36.4439 104.622 36.654 104.885 36.956C105.147 37.2449 105.331 37.6651 105.436 38.2167L106.499 42.3925H102.029L101.143 38.3545C101.064 37.9737 100.939 37.7242 100.769 37.606C100.611 37.4878 100.349 37.4288 99.9809 37.4288C98.9962 37.4156 98.1888 37.4091 97.5586 37.4091C96.9416 37.4091 96.4164 37.4025 95.9832 37.3894C95.5499 37.3762 95.1167 37.3565 94.6834 37.3303L94.7425 34.415H100.138C100.545 34.415 100.861 34.3756 101.084 34.2968C101.307 34.2181 101.458 34.0802 101.537 33.8832C101.629 33.6731 101.675 33.3842 101.675 33.0165C101.675 32.6357 101.629 32.3468 101.537 32.1498C101.458 31.9528 101.307 31.8149 101.084 31.7362C100.861 31.6574 100.545 31.618 100.138 31.618C98.7731 31.618 97.6243 31.6245 96.6921 31.6377C95.76 31.6508 95.1232 31.6771 94.7819 31.7165L94.4668 28.8012C95.0707 28.7356 95.6353 28.6896 96.1604 28.6633C96.6987 28.6371 97.2829 28.6239 97.9131 28.6239C98.5564 28.6108 99.331 28.6042 100.237 28.6042ZM98.6615 28.8012V42.3925H94.4668V28.8012H98.6615Z" fill="#16181D"/>
<path d="M85.827 28.7225C86.6148 28.7225 87.4222 28.7291 88.2493 28.7422C89.0895 28.7422 89.9101 28.7619 90.711 28.8013C91.5118 28.8276 92.2405 28.8867 92.8969 28.9786L92.7 31.9923H87.7176C87.4681 31.9923 87.2712 32.058 87.1268 32.1893C86.9824 32.3206 86.9102 32.4913 86.9102 32.7014V38.4925C86.9102 38.7026 86.9824 38.8733 87.1268 39.0047C87.2712 39.136 87.4681 39.2016 87.7176 39.2016H92.7L92.8969 42.2154C92.2405 42.2941 91.5118 42.3532 90.711 42.3926C89.9101 42.432 89.0895 42.4517 88.2493 42.4517C87.4222 42.4649 86.6148 42.4714 85.827 42.4714C84.8949 42.4714 84.1268 42.1891 83.5229 41.6244C82.9321 41.0466 82.6367 40.2981 82.6367 39.3789V31.815C82.6367 30.8958 82.9321 30.1539 83.5229 29.5892C84.1268 29.0114 84.8949 28.7225 85.827 28.7225ZM82.9912 34.0212H91.991V36.8576H82.9912V34.0212Z" fill="#16181D"/>
<path d="M75.7543 28.6042C77.1985 28.6042 78.3276 28.7421 79.1416 29.0179C79.9556 29.2805 80.5332 29.7467 80.8746 30.4164C81.2159 31.0861 81.3866 32.0251 81.3866 33.2332C81.3866 34.4282 81.2225 35.3605 80.8943 36.0302C80.5792 36.6868 80.054 37.153 79.3188 37.4288C78.5836 37.6914 77.5924 37.8227 76.3451 37.8227C75.6887 37.8227 75.0323 37.7899 74.3758 37.7242C73.7194 37.6454 73.1023 37.5535 72.5246 37.4485C71.9601 37.3303 71.4743 37.2121 71.0673 37.0939C70.6603 36.9626 70.3781 36.8444 70.2205 36.7393L70.2796 34.809C71.133 34.809 72.0192 34.809 72.9382 34.809C73.8572 34.809 74.7631 34.809 75.6559 34.809C76.0497 34.809 76.3517 34.7696 76.5618 34.6908C76.7718 34.5989 76.9162 34.4413 76.995 34.2181C77.0738 33.9817 77.1132 33.6534 77.1132 33.2332C77.1132 32.7998 77.0738 32.465 76.995 32.2286C76.9162 31.9922 76.7718 31.8346 76.5618 31.7559C76.3517 31.6639 76.0497 31.618 75.6559 31.618C74.3167 31.618 73.1745 31.6245 72.2292 31.6377C71.284 31.6508 70.6407 31.6771 70.2993 31.7165L70.0039 28.8012C70.6078 28.7356 71.1724 28.6896 71.6975 28.6633C72.2358 28.6371 72.82 28.6239 73.4502 28.6239C74.0804 28.6108 74.8484 28.6042 75.7543 28.6042ZM74.2773 28.8012V42.3925H70.0039V28.8012H74.2773Z" fill="#16181D"/>
<path d="M62.0071 28.5255C63.1755 28.5255 64.1602 28.6371 64.9611 28.8604C65.7751 29.0705 66.4315 29.4382 66.9304 29.9634C67.4293 30.4887 67.7903 31.2109 68.0135 32.1302C68.2367 33.0363 68.3483 34.1918 68.3483 35.5969C68.3483 36.9889 68.2367 38.1445 68.0135 39.0637C67.7903 39.9829 67.4293 40.7052 66.9304 41.2304C66.4315 41.7557 65.7751 42.13 64.9611 42.3532C64.1602 42.5633 63.1755 42.6684 62.0071 42.6684C60.8517 42.6684 59.8671 42.5633 59.0531 42.3532C58.2522 42.13 57.6024 41.7557 57.1035 41.2304C56.6046 40.7052 56.2435 39.9829 56.0203 39.0637C55.7971 38.1445 55.6855 36.9889 55.6855 35.5969C55.6855 34.1918 55.7971 33.0363 56.0203 32.1302C56.2435 31.2109 56.6046 30.4887 57.1035 29.9634C57.6024 29.4382 58.2522 29.0705 59.0531 28.8604C59.8671 28.6371 60.8517 28.5255 62.0071 28.5255ZM62.0071 31.6968C61.5213 31.6968 61.1471 31.8019 60.8846 32.012C60.622 32.2221 60.4382 32.6095 60.3332 33.1741C60.2281 33.7388 60.1756 34.5464 60.1756 35.5969C60.1756 36.6475 60.2281 37.4551 60.3332 38.0197C60.4382 38.5844 60.622 38.9718 60.8846 39.1819C61.1471 39.392 61.5213 39.4971 62.0071 39.4971C62.4928 39.4971 62.867 39.392 63.1296 39.1819C63.3922 38.9718 63.576 38.5844 63.681 38.0197C63.786 37.4551 63.8386 36.6475 63.8386 35.5969C63.8386 34.5464 63.786 33.7388 63.681 33.1741C63.576 32.6095 63.3922 32.2221 63.1296 32.012C62.867 31.8019 62.4928 31.6968 62.0071 31.6968Z" fill="#16181D"/>
<path d="M48.6383 28.6042C49.9774 28.6042 51.0671 28.729 51.9074 28.9785C52.7476 29.228 53.3647 29.6548 53.7585 30.2588C54.1655 30.8498 54.369 31.6771 54.369 32.7407C54.369 33.2791 54.2837 33.7847 54.113 34.2574C53.9555 34.7171 53.6732 35.0979 53.2662 35.3999C52.8723 35.7019 52.3209 35.8923 51.612 35.9711V36.0893C51.8614 36.1156 52.1371 36.1944 52.4391 36.3257C52.741 36.4439 53.0233 36.654 53.2859 36.956C53.5485 37.2449 53.7323 37.6651 53.8373 38.2167L54.9007 42.3925H50.4304L49.5442 38.3545C49.4654 37.9737 49.3407 37.7242 49.17 37.606C49.0125 37.4878 48.7499 37.4288 48.3823 37.4288C47.3976 37.4156 46.5902 37.4091 45.96 37.4091C45.3429 37.4091 44.8178 37.4025 44.3845 37.3894C43.9513 37.3762 43.518 37.3565 43.0848 37.3303L43.1439 34.415H48.5398C48.9468 34.415 49.2619 34.3756 49.4851 34.2968C49.7083 34.2181 49.8593 34.0802 49.938 33.8832C50.0299 33.6731 50.0759 33.3842 50.0759 33.0165C50.0759 32.6357 50.0299 32.3468 49.938 32.1498C49.8593 31.9528 49.7083 31.8149 49.4851 31.7362C49.2619 31.6574 48.9468 31.618 48.5398 31.618C47.1744 31.618 46.0256 31.6245 45.0935 31.6377C44.1614 31.6508 43.5246 31.6771 43.1833 31.7165L42.8682 28.8012C43.4721 28.7356 44.0366 28.6896 44.5618 28.6633C45.1001 28.6371 45.6843 28.6239 46.3145 28.6239C46.9578 28.6108 47.7324 28.6042 48.6383 28.6042ZM47.0628 28.8012V42.3925H42.8682V28.8012H47.0628Z" fill="#16181D"/>
<path d="M35.8871 28.6041C37.3313 28.6041 38.4604 28.742 39.2744 29.0178C40.0884 29.2804 40.666 29.7466 41.0074 30.4163C41.3487 31.086 41.5194 32.0249 41.5194 33.2331C41.5194 34.428 41.3553 35.3604 41.0271 36.0301C40.712 36.6867 40.1868 37.1529 39.4516 37.4286C38.7164 37.6913 37.7252 37.8226 36.4779 37.8226C35.8215 37.8226 35.1651 37.7898 34.5086 37.7241C33.8522 37.6453 33.2351 37.5534 32.6575 37.4483C32.0929 37.3301 31.6071 37.212 31.2002 37.0938C30.7932 36.9625 30.5109 36.8443 30.3533 36.7392L30.4124 34.8089C31.2658 34.8089 32.152 34.8089 33.071 34.8089C33.99 34.8089 34.8959 34.8089 35.7887 34.8089C36.1825 34.8089 36.4845 34.7695 36.6946 34.6907C36.9046 34.5987 37.049 34.4412 37.1278 34.2179C37.2066 33.9816 37.246 33.6533 37.246 33.2331C37.246 32.7997 37.2066 32.4648 37.1278 32.2285C37.049 31.9921 36.9046 31.8345 36.6946 31.7557C36.4845 31.6638 36.1825 31.6179 35.7887 31.6179C34.4495 31.6179 33.3073 31.6244 32.3621 31.6375C31.4168 31.6507 30.7735 31.6769 30.4321 31.7163L30.1367 28.8011C30.7406 28.7354 31.3052 28.6895 31.8303 28.6632C32.3686 28.637 32.9529 28.6238 33.583 28.6238C34.2132 28.6107 34.9813 28.6041 35.8871 28.6041ZM34.4102 28.8011V42.3924H30.1367V28.8011H34.4102Z" fill="#16181D"/>
<path d="M74.5772 12.1011V25.6924H70.3037V12.1011H74.5772ZM78.378 12.1011V15.2921H66.5029V12.1011H78.378Z" fill="#16181D"/>
<path d="M60.4698 11.8254C61.1788 11.8254 61.9731 11.8714 62.8527 11.9633C63.7455 12.0421 64.5989 12.226 65.4128 12.5149L65.1568 15.2528C64.566 15.2397 63.8308 15.2331 62.9512 15.2331C62.0847 15.22 61.2247 15.2134 60.3714 15.2134C60.1219 15.2134 59.9119 15.22 59.7412 15.2331C59.5836 15.2462 59.4589 15.2725 59.367 15.3119C59.2751 15.3513 59.2095 15.4038 59.1701 15.4695C59.1307 15.5351 59.111 15.6205 59.111 15.7256C59.111 15.9094 59.1898 16.067 59.3473 16.1983C59.518 16.3165 59.8331 16.4675 60.2926 16.6513L62.7543 17.6756C63.8833 18.1615 64.6711 18.7261 65.1174 19.3696C65.577 19.9999 65.8067 20.8141 65.8067 21.8121C65.8067 22.5737 65.7148 23.2238 65.531 23.7622C65.3472 24.2874 65.0387 24.7142 64.6054 25.0425C64.1853 25.3577 63.6208 25.5875 62.9118 25.7319C62.2028 25.8895 61.3166 25.9683 60.2532 25.9683C59.7937 25.9683 59.0979 25.9289 58.1657 25.8501C57.2336 25.7844 56.1767 25.6006 54.9951 25.2986L55.2511 22.3045C56.0389 22.3177 56.7609 22.3374 57.4174 22.3636C58.0738 22.3768 58.6384 22.3899 59.111 22.403C59.5968 22.403 59.9578 22.403 60.1941 22.403C60.5617 22.403 60.8374 22.3899 61.0212 22.3636C61.2182 22.3374 61.3495 22.2914 61.4151 22.2257C61.4939 22.147 61.5333 22.0485 61.5333 21.9303C61.5333 21.799 61.507 21.6939 61.4545 21.6151C61.402 21.5232 61.3101 21.4378 61.1788 21.3591C61.0475 21.2803 60.8571 21.1949 60.6077 21.103L57.9097 19.9211C56.8069 19.4221 56.0257 18.864 55.5662 18.2468C55.1067 17.6297 54.877 16.8221 54.877 15.824C54.877 15.0493 54.9754 14.4058 55.1724 13.8937C55.3824 13.3815 55.7041 12.9745 56.1373 12.6724C56.5706 12.3704 57.1417 12.1537 57.8506 12.0224C58.5727 11.8911 59.4458 11.8254 60.4698 11.8254Z" fill="#16181D"/>
<path d="M49.5083 12.1011C49.8496 12.1011 50.1516 12.1996 50.4142 12.3965C50.6768 12.5935 50.854 12.8627 50.9459 13.2041L54.471 25.6924H50.1188L48.0707 16.8482C48.0182 16.5987 47.9722 16.3426 47.9328 16.08C47.8934 15.8042 47.8606 15.5416 47.8344 15.2921H47.3026C47.2764 15.5416 47.2436 15.8042 47.2042 16.08C47.1648 16.3426 47.1188 16.5987 47.0663 16.8482L45.0182 25.6924H40.666L44.1911 13.2041C44.283 12.8627 44.4602 12.5935 44.7228 12.3965C44.9854 12.1996 45.2874 12.1011 45.6287 12.1011H49.5083ZM51.1822 19.7634V22.7575H43.9548V19.7634H51.1822Z" fill="#16181D"/>
<path d="M33.2284 12.0225C34.0161 12.0225 34.8235 12.029 35.6507 12.0422C36.4909 12.0422 37.3115 12.0619 38.1123 12.1013C38.9132 12.1275 39.6418 12.1866 40.2983 12.2785L40.1013 15.2923H35.1189C34.8695 15.2923 34.6726 15.3579 34.5281 15.4892C34.3837 15.6205 34.3115 15.7913 34.3115 16.0014V21.7924C34.3115 22.0026 34.3837 22.1733 34.5281 22.3046C34.6726 22.4359 34.8695 22.5016 35.1189 22.5016H40.1013L40.2983 25.5153C39.6418 25.5941 38.9132 25.6532 38.1123 25.6926C37.3115 25.732 36.4909 25.7517 35.6507 25.7517C34.8235 25.7648 34.0161 25.7714 33.2284 25.7714C32.2962 25.7714 31.5282 25.489 30.9243 24.9244C30.3335 24.3466 30.0381 23.5981 30.0381 22.6788V15.115C30.0381 14.1958 30.3335 13.4538 30.9243 12.8892C31.5282 12.3114 32.2962 12.0225 33.2284 12.0225ZM30.3926 17.3211H39.3924V20.1575H30.3926V17.3211Z" fill="#16181D"/>
</svg>`;

  // src/js/mortgage-calculator/modules/pdf/styles.js
  ...
  // src/js/mortgage-calculator/modules/pdf/template.js
  function buildPdfHtml({ state, metrics, entryCosts, refId, dateStr }) {
    const currency = "AED";
...
<div class="doc-wrap">
	...
	<div class="doc-headline">
		...
		<div class="doc-sub">Property financing estimate and upfront acquisition breakdown \xB7 East Property Advisory</div>
	</div>
	...
	<footer class="doc-footer">
		...
		<div class="doc-contacts">
			...
			+971 56 680 9684 \xB7 Dubai, UAE<br>
			eastproperty.com
		</div>
	</footer>
  ...
  // src/js/mortgage-calculator/modules/pdf/printer.js
  function printHtml(html) {
    ...
    const doc = (_a2 = iframe.contentWindow) == null ? void 0 : _a2.document;
    if (!doc) {
    ...
    setTimeout(() => {
      var _a3;
      (_a3 = iframe.contentWindow) == null ? void 0 : _a3.print();
      setTimeout(() => {
  ...
  // src/js/mortgage-calculator/modules/pdf/index.js
  function generateMortgagePdf(state) {
  ...
  // src/js/mortgage-calculator/modules/controller.js
  var MortgageCalculator = class {
    ...
    isValid() {
      return Boolean(
        this.elements.priceSlider && this.elements.monthlyPayment && this.elements.donutCanvas
      );
    }
    initEventListeners() {
      var _a2, _b2, _c2;
      const { elements } = this;
      (_a2 = elements.resBtn) == null ? void 0 : _a2.addEventListener("click", () => this.setResidency(true));
      (_b2 = elements.nonResBtn) == null ? void 0 : _b2.addEventListener("click", () => this.setResidency(false));
      this.bindSlider(elements.priceSlider, (val) => {
        this.state.price = val;
      });
      this.bindSlider(elements.downSlider, (val) => {
        this.state.downPct = val;
      });
      this.bindSlider(elements.termSlider, (val) => {
        this.state.years = val;
      });
      this.bindSlider(elements.rateSlider, (val) => {
        this.state.rate = val;
      });
      this.bindTextInput(elements.priceInput, elements.priceSlider, (val) => {
        this.state.price = val;
      });
      this.bindTextInput(elements.downInput, elements.downSlider, (val) => {
        this.state.downPct = val;
      });
      this.bindTextInput(elements.termInput, elements.termSlider, (val) => {
        this.state.years = val;
      });
      this.bindTextInput(elements.rateInput, elements.rateSlider, (val) => {
        this.state.rate = val;
      });
      (_c2 = elements.downloadBtn) == null ? void 0 : _c2.addEventListener("click", () => {
        generateMortgagePdf(this.state);
      });
    }
    bindSlider(sliderEl, stateUpdater) {
      if (!sliderEl) return;
      sliderEl.addEventListener("input", (event2) => {
        const value = parseNumericInput(event2.target.value);
        stateUpdater(value);
        this.scheduleRender();
      });
    }
    bindTextInput(inputEl, sliderEl, stateUpdater) {
      ...
      inputEl.addEventListener("focus", () => {
        var _a2;
        (_a2 = inputEl.closest(".calc-input-box")) == null ? void 0 : _a2.classList.remove("is-clamped");
      });
      inputEl.addEventListener("change", () => {
        ...
        if (isClamped) {
          (_a2 = inputEl.closest(".calc-input-box")) == null ? void 0 : _a2.classList.add("is-clamped");
        }
        this.scheduleRender();
      });
    }
    setResidency(isResident) {
      ...
      const { elements } = this;
      (_a2 = elements.resBtn) == null ? void 0 : _a2.classList.toggle("is-active", isResident);
      (_b2 = elements.resBtn) == null ? void 0 : _b2.setAttribute("aria-selected", String(isResident));
      (_c2 = elements.nonResBtn) == null ? void 0 : _c2.classList.toggle("is-active", !isResident);
      (_d2 = elements.nonResBtn) == null ? void 0 : _d2.setAttribute("aria-selected", String(!isResident));
    ...
    render() {
      ...
      (_a2 = this.chart) == null ? void 0 : _a2.animateTo(metrics.principalPct);
    ...
    destroy() {
      var _a2;
      (_a2 = this.chart) == null ? void 0 : _a2.destroy();
    }
  };

  // src/js/mortgage-calculator/index.js
  function initMortgageCalculator(target = "[data-mortgage-calculator]") {
    const root = typeof target === "string" ? document.querySelector(target) || document.getElementById("mortgage-calculator") : target;
  ...
  // core/components/filters/result-filters.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    initMinMaxFields();
    initPrettyNumbers();
  });
  var initMinMaxFields = () => {
    ...
    minMaxWrappers.forEach((wrapper) => {
      ...
      apply == null ? void 0 : apply.addEventListener("click", () => {
  ...
  // core/components/account/account.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
  ...
  var initChangeProjectImages = () => {
    ...
    propertyIdInputs.forEach((propertyIdInput) => {
      propertyIdInput.addEventListener("change", () => {
        let propertyId = propertyIdInput.value, uploadsBlock = document.querySelector(".uploader-presets .uploader-grid"), formData = new FormData();
  ...
  var initAvatarUploader = () => {
    ...
    uploaderWrapper.addEventListener("drop", (e) => {
      ...
      handleAvatarFile(file);
      if ((_d2 = (_c2 = e.dataTransfer) == null ? void 0 : _c2.files) == null ? void 0 : _d2.length) {
  ...
  var initValidationForRegistrationForms = () => {
    ...
    registrationForms.forEach((form) => {
      form.addEventListener("submit", (e) => {
        ...
        const passwordInput = form.querySelector('input[name="user_password"]'), confirmPasswordInput = form.querySelector('input[name="repeat_password"]');
  ...
  var initLangSwitcher = () => {
    ...
    langButtons.forEach((langButton) => {
      langButton.addEventListener("click", (e) => {
        ...
        currentLangBtn == null ? void 0 : currentLangBtn.classList.remove("current");
  ...
  var syncLangValues = () => {
    ...
    syncInputs == null ? void 0 : syncInputs.forEach((input) => {
      input.addEventListener("input", (e) => {
    ...
    syncCheckboxGroups == null ? void 0 : syncCheckboxGroups.forEach((group) => {
    ...
    syncDropdowns == null ? void 0 : syncDropdowns.forEach((dropdown) => {
      dropdown.addEventListener("change", (e) => {
        ...
        syncDropdowns.forEach((syncDropdown) => {
          ...
          syncTitle.textContent = (_a2 = syncDropdown.querySelector('.dropdown-option[data-value="' + value + '"]')) == null ? void 0 : _a2.textContent;
        });
      });
    });
    const bedsBathsButtons = document.querySelectorAll(".submit-buttons-wrapper[data-lang-sync] .beds-baths-btn");
    bedsBathsButtons == null ? void 0 : bedsBathsButtons.forEach((button) => {
      button.addEventListener("click", (e) => {
  ...
  // core/components/cards/cards.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    initCardsActions();
  });
  var initCardsActions = () => {
    document.addEventListener("click", (e) => {
  ...
  // core/components/ui/tooltip/tooltip.js
  function initTooltips() {
    ...
    document.addEventListener("click", (event2) => {
      if (!event2.target.closest(".tooltip")) {
        closeAllTooltips();
      }
    });
  ...
  // core/components/common/notifications/notifications.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    initNotifications();
  });
  var initNotifications = () => {
    ...
    notifications == null ? void 0 : notifications.forEach((notification) => {
      setTimeout(() => {
  ...
  // core/components/common/subscribe-form/subscribe-form.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    initSubscriptionForm();
  });
  var initSubscriptionForm = () => {
    ...
    form.addEventListener("submit", (e) => {
      ...
      let submitBtn = form.querySelector('button[type="submit"]'), submitText = submitBtn.querySelector("span");
      if (submitBtn) {
  ...
  // core/components/modals/modals.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    initBoostModal();
    initForgotModal();
  ...
  var initBoostModal = () => {
    document.addEventListener("submit", (e) => {
      ...
      if (form.name === "boost_form") {
        e.preventDefault();
        const modalWrapper = form.closest(".modal-wrapper"), modal = modalWrapper == null ? void 0 : modalWrapper.querySelector(".modal"), closeModal = modal == null ? void 0 : modal.querySelector(".modal-close");
        if (!modal) return;
        let unitId = modalWrapper.dataset.unit_id;
        if (!unitId) {
          closeModal == null ? void 0 : closeModal.click();
  ...
  var initForgotModal = () => {
    ...
    const signInModal = document.querySelector(".signin-modal"), signInModalClose = signInModal == null ? void 0 : signInModal.querySelector(".modal-close");
    forgotForm.addEventListener("submit", (e) => {
      e.preventDefault();
      const modalWrapper = forgotForm.closest(".modal-wrapper"), emailInput = modalWrapper.querySelector('input[name="email"]'), modal = modalWrapper == null ? void 0 : modalWrapper.querySelector(".modal"), closeModal = modal == null ? void 0 : modal.querySelector(".modal-close");
      ...
      fetch(ajax_object.ajax_url, {
        ...
        setTimeout(() => {
          modal.classList.remove("preloader");
          closeModal == null ? void 0 : closeModal.click();
          signInModalClose == null ? void 0 : signInModalClose.click();
          if (response.success) {
            window.showNotification(response.data.message, "success");
          } else {
            window.showNotification(response.data.message, "error");
  ...
  // core/components/common/cookies/cookies.js
  document.addEventListener("DOMContentLoaded", () => {
    "use strict";
    initCookiesNotification();
  });
  var initCookiesNotification = () => {
    var _a2, _b2;
    ...
    (_a2 = document.getElementById("cookie-accept")) == null ? void 0 : _a2.addEventListener("click", function() {
      localStorage.setItem("eastproperty_cookie_consent", "accepted");
      cookieNotice.style.display = "none";
    });
    (_b2 = document.getElementById("cookie-decline")) == null ? void 0 : _b2.addEventListener("click", function() {
