                ...
                <div class="footer-info">
                    <div class="subscribe">
                        ...
                        <button class="button orange xl">
                            <img src="/wp-content/themes/messia-child/assets/img/bell.svg" width="16" height="16" alt="Subscribe">
                            Subscribe
                        </button>
                    </div>
                    <a class="footer-logo" href="/">
                        <img class="footer-logo" src="/wp-content/themes/messia-child/assets//img/logo.svg" width="132" height="50" alt="Vector logotype">
                    </a>
