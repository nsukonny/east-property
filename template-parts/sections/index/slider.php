...
$new_items = get_field( 'new_items', 'option' );
...
$categories = get_terms(
        array(
                ...
                'parent'     => 0,
                'exclude'    => array(
                        get_term_by( 'slug', 'new', 'product_cat' )->term_id //TODO move to setting
                )
        )
);
        ...
        array(
                ...
                'tax_query'      => array(
                        array(
                                'taxonomy' => 'product_cat',
                                'field'    => 'slug',
                                'terms'    => 'new', //TODO move to setting
                        ),
                ),
        )
);
...
<section class="cards-slider">
    <?php if ( ! empty( $new_items['seo_title'] ) ) { ?>
        <h2 class="sr-only"><?php echo esc_html( $new_items['seo_title'] ); ?></h2>
    <?php } ?>

    <div class="container">
        <div class="cards-slider-wrapper">
            <div class="cards-slider-title">
                <?php if ( ! empty( $new_items['title'] ) ) { ?>
                    <h3><?php echo esc_html( $new_items['title'] ); ?></h3>
                <?php } ?>

                <?php if ( ! empty( $new_items['description'] ) ) { ?>
                    <div class="texts">
                        <p>
                            <?php echo esc_html( $new_items['description'] ); ?>
                        </p>
                    </div>
                <?php } ?>
            </div>
